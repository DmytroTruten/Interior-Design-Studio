export function animateNavbarDesktop() {
  ...
  setTimeout(() => {
    headerRightSection.children[0].style.animation = "reveal-to-left 1s ease-in-out";
    headerRightSection.children[0].style.opacity = 1;
  }, 800);
  setTimeout(() => {
    headerRightSection.children[1].style.animation = "reveal-to-left 1s ease-in-out";
